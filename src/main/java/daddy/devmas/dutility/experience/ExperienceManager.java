package daddy.devmas.dutility.experience;
...
public class ExperienceManager {
    ...
    private DUtility du;
    public ExperienceManager(DUtility du) { this.du = du; }
    ...
    public void setCurrentExperience(Player player, int xp) {
        //Levels 0 through 15
        if(xp >= 0 && xp < 351) {
    ...
    private float round(float d, int decimal) {
        ...
        bd = bd.setScale(decimal, BigDecimal.ROUND_HALF_DOWN);
