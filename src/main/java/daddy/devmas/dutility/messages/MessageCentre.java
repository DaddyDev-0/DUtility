...
public enum MessageCentre {
    ...
    MessageCentre(char character, int length) {
    ...
    public static MessageCentre getDefaultFontInfo(char c) {
        for (MessageCentre dFI : values()) {
    ...
    public static String centerMOTD(String message) {
        ...
        for (char c : message.toCharArray()) {
            if (c == '§') {
                ...
                MessageCentre dFI = getDefaultFontInfo(c);
    ...
    public static String chatCentre(String message) {
